...
// configuration step. It creates a namespace called `cmake_example`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", cmake_example::cmake::project_name, cmake_example::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", cmake_example::cmake::project_version);
      return EXIT_SUCCESS;
    }
